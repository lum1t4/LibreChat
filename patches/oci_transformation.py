    ...
    def _emit_chunk(self, parsed: ModelResponseStream) -> ModelResponseStream:
        for choice in parsed.choices:
            ...
            if choice.finish_reason is not None:
                # OCI Gemini may end a streamed tool call with COMPLETE,
                # which the generic parser maps to stop. Preserve the tool
                # call signal for OpenAI-compatible streaming clients.
                if choice.finish_reason == "stop" and self.tool_call:
